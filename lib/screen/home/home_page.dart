                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  '\$${populerGame[index].price.toStringAsFixed(0)}',
                                  style: TextStyle(
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (builder) => DetailsPage(game: games[index]),
          ),
        );
      },
      child: Container(
